...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def __init__(self, mdp, discount = 0.9, iterations = 100):
        ...
        for iteration in range(iterations):
            #make sure the same iteration use the same time subscript for state and nextstate
            #suppose state and nextstate can jump around, state0->state1,then we need to get nextstate1
            #by state0 rather than state1.
